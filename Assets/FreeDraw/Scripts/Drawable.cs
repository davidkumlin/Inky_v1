...
//////////////////////////////////////////////////////////////////////////////
        ...
        void Update()
        {
            ...
            if (mouse_held_down && !no_drawing_on_current_drag)
            {
                ...
                Vector2 aim_position = aimMovement.CurrentAim; // Get the current aim position
                Collider2D hit = Physics2D.OverlapPoint(aim_position, Drawing_Layers.value);
                if (hit != null && hit.transform != null)
                {
                    // We're over the texture we're drawing on!
                    // Use whatever function the current brush is
                    current_brush(aim_position);
                }
        ...
        void Awake()
        {
            ...
            // Find and cache the AimMovement script
